...
<form action="template-upload.php" method="post" enctype="multipart/form-data">
    <div style="margin-top:100px;"class="row">
      ...
      <select name="vendorname" id="vendor">
...
// if everything is ok, try to upload file
  ...
  if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
    ...
    ?> <button class="btn btn-primary"><a href="template-send.php?filename=<?php echo $_FILES['fileToUpload']['name'] ;?>&subject=<?php echo $_POST['subject'];?>&vendorname=<?php echo $_POST['vendorname'];?>" style="text-decoration:none;color:white;">SEND</a></button><?php
  } else {
