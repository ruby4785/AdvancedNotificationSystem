<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql2 = "INSERT INTO notifications (UserID,VendorID,Message) VALUES('$user','$vendor','$msg')";
        ...
        $header="From: ".$vendorName.' '.'<'.$fetch['Email'].'>';
        
        mail($final,$subject,$msg,$header);

        $vendorid=$_SESSION['VendorID'];
        $message=$_POST['text'];
        $sql="select Phone from clients where VendorID=$vendorid;";
