<?php
  ...
  $sql="select * from clients where VendorID=$vendorid and Deleted=0;";
  $fire=mysqli_query($conn,$sql);
  
  $sql="select * from notifications where VendorID=$vendorid;";
  $fire2=mysqli_query($conn,$sql);
  $sql="select * from usermaster where VendorID='$vendorid' and Deleted=0;";
...
<body> 
     <!-- Image and text -->
     <nav style="border-bottom:solid 0.1px black;" class="navbar navbar-lightbg-light">
            <a style="color:white;" class="navbar-brand" href="admin-view.php">
                ...
                <div class="col-lg-4">
                    <div class="card text-white mb-3" style="max-width: 30rem;">
                      ...
                      <div class="card-body">
                        ...
                        <button style="margin-left:150px;"class="btn btn-lg btn-block btn-dark" type="button"><a href="view-clients.php" style="text-decoration:none; color:#FFFFFF">ADD</a></button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-lg-4">
                    <div class="card text-white  mb-3" style="max-width: 30rem;">
                      ...
                      <div class="card-body">
                        ...
                        <button style="margin-left:150px;"class="btn btn-lg btn-block btn-dark" type="button"><a href="template-upload.php" style="text-decoration:none; color:#FFFFFF">View</a></button>
                      </div>
                    </div>
                  </div>
    </section>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-4">
                  ...
                  <div class="col-lg-4">
                    <button style="margin:180px 0 0 220px;" class="btn btn-lg btn-block btn-primary" type="button"><a href="change-password.php" style="text-decoration:none; color:#FFFFFF">Change Password</a></button>
